package com.nexos
{
	...
	public class Nexos2 extends MovieClip
	{
		...
		public function Nexos2()
		{
			...
			espacioTiempoDos.addEventListener(TimerEvent.TIMER,esperarTiempoDos);
			espacioTiempoTres.addEventListener(TimerEvent.TIMER,esperarTiempoTres);
			espacioTiempoCuatro.addEventListener(TimerEvent.TIMER,esperarTiempoCuatro);
		}
		...
		public function desordenarNubes()
		{
			...
			function agregarListeners(item: * ,index:Number,array:Array)
			{
				switch (nivelActual)
				{
					...
					case 2 :
						item.addEventListener(MouseEvent.CLICK,asignarSeleccionDos);
						break;

					case 3 :
						item.addEventListener(MouseEvent.CLICK,asignarSeleccionTres);
						break;

					case 4 :
						item.addEventListener(MouseEvent.CLICK,asignarSeleccionCuatro);
						break;
				}
				...
				function asignarSeleccion()
				{
					...
					if (espacioTiempo.running != true)
					{
						...
						if (listaNubes[seleccion].seleccionado == false)
						{
							listaNubes[seleccion].agregarImagen(listaNubes[seleccion].urlImagen);
						}
						else
						{
				...
				function asignarSeleccionDos()
				{
					...
					if (espacioTiempo.running != true)
					{
						...
						else if (segundoTipo == 0)
						{
							segundoTipo = listaNubes[seleccion].tipoNube;
						}
						else
						{
							tercerTipo = listaNubes[seleccion].tipoNube;
						}

						if (primerTipo != 0 && segundoTipo != 0 && tercerTipo != 0)
						{
							compararTiposDos();
						}
					}
				...
				function asignarSeleccionTres()
				{
					...
					if (espacioTiempo.running != true)
					{
						...
						else if (tercerTipo == 0)
						{
							tercerTipo = listaNubes[seleccion].tipoNube;
						}
						else
						{
							cuartoTipo = listaNubes[seleccion].tipoNube;
						}

						if (primerTipo != 0 && segundoTipo != 0 && tercerTipo != 0 && cuartoTipo != 0)
						{
							compararTiposTres();
						}
					}
				...
				function asignarSeleccionCuatro()
				{
					trace("SELECCION4");
					if (espacioTiempo.running != true)
					{
						...
						else if (cuartoTipo == 0)
						{
							cuartoTipo = listaNubes[seleccion].tipoNube;
						}
						else
						{
							quintoTipo = listaNubes[seleccion].tipoNube;
						}

						if (primerTipo != 0 && segundoTipo != 0 && tercerTipo != 0 && cuartoTipo != 0 && quintoTipo != 0)
						{
							compararTiposCuatro();
						}
					}
		...
		public function compararTiposDos()
		{
			trace("COMPARAR2");
			espacioTiempoDos.start();
		}

		function esperarTiempoDos(evento:TimerEvent)
		{
			trace("ESPERAR 2");
			trace(primerTipo,segundoTipo,tercerTipo);
			trace(seleccion,antiguaSeleccion,dosAntiguaSeleccion);
			if (primerTipo == segundoTipo && primerTipo == tercerTipo)
			{
				trace("Iguales");
				if (seleccion != antiguaSeleccion && seleccion != dosAntiguaSeleccion)
				{
					if (jugadorActual == 1)
					{
						parejasJugador1 +=  1;
		...
		public function compararTiposTres()
		{
			trace("COMPARAR3");
			espacioTiempoTres.start();
		}

		function esperarTiempoTres(evento:TimerEvent)
		{
			trace("ESPERAR 3");
			trace(primerTipo,segundoTipo,tercerTipo,cuartoTipo);
			trace(seleccion,antiguaSeleccion,dosAntiguaSeleccion,tresAntiguaSeleccion);
			if (primerTipo == segundoTipo && primerTipo == tercerTipo && primerTipo == cuartoTipo)
			{
				trace("Iguales");
				if (seleccion != antiguaSeleccion && seleccion != dosAntiguaSeleccion && seleccion != tresAntiguaSeleccion)
				{
					if (jugadorActual == 1)
					{
						parejasJugador1 +=  1;
		...
		public function compararTiposCuatro()
		{
			trace("COMPARAR4");
			espacioTiempoCuatro.start();
		}

		function esperarTiempoCuatro(evento:TimerEvent)
		{
			trace("ESPERAR 4");
			trace(primerTipo,segundoTipo,tercerTipo,cuartoTipo,quintoTipo);
			trace(seleccion,antiguaSeleccion,dosAntiguaSeleccion,tresAntiguaSeleccion,cuatroAntiguaSeleccion);
			if (primerTipo == segundoTipo && primerTipo == tercerTipo && primerTipo == cuartoTipo && primerTipo == quintoTipo)
			{
				trace("Iguales");
				if (seleccion != antiguaSeleccion && seleccion != dosAntiguaSeleccion && seleccion != tresAntiguaSeleccion && seleccion != cuatroAntiguaSeleccion)
				{
					if (jugadorActual == 1)
					{
						parejasJugador1 +=  1;
		...
		public function generarNubes()
		{
			...
			for (var i:Number = 1; i <= numeroFilas; i++)
			{
				for (var j:Number = 1; j <= numeroColumnas && cantidad < numeroNubes; j++)
				{
					...
					listaNubes[cantidad].x = posX;
					listaNubes[cantidad].y = posY;
